    ...
    def __call__(self, module):
        if isinstance(module, nn.Conv3d) or isinstance(module, nn.Conv2d) or isinstance(module, nn.ConvTranspose2d) or isinstance(module, nn.ConvTranspose3d):
            ...
            if module.bias is not None:
                module.bias = nn.init.constant_(module.bias, 0.01)
...
def init_last_bn_before_add_to_0(module):
    if isinstance(module, BasicBlockD):
        ...
        module.conv2.norm.bias = nn.init.constant_(module.conv2.norm.bias, 0.01)
    if isinstance(module, BottleneckD):
        module.conv3.norm.weight = nn.init.constant_(module.conv3.norm.weight, 0)
        module.conv3.norm.bias = nn.init.constant_(module.conv3.norm.bias, 0.01)
